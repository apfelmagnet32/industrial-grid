...
/**
 * Sibling of PowerGrid's HvSwitchRenderer, reusing the same partial models. Unlike PowerGrid's
 * own version, this always renders through the BER path (no Flywheel Visual is registered for
 * this block entity, so skipping render when Flywheel is active - as PowerGrid's renderer does -
 * would leave the shaft/rod invisible; see IndustrialBreakerRenderer for the same reasoning).
 */
